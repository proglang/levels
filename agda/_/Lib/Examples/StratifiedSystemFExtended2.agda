...
module Code.Examples.StratifiedSystemFExtended2 where
  
module Types where
  open import Code.ExtendedLevel using (Level; zero; one; suc; ω; ω+1; ω↑_+_; _⊔_; β-suc-zero; β-suc-ω; cast)
  open import Code.BoundedLevelQuantification using (Level[_])
  open Level[_]
  ...
  module Denotational where
    ...
    open import Code.ExtendedLevel using (Setε₀)
