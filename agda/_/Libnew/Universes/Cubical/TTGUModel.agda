{-# OPTIONS --cubical #-}
open import Code.Lib.Universes.Cubical.IRUniverse
open import Code.Lib.Universes.Cubical.Lib
open import Data.Nat using (ℕ; zero; suc)

module Code.Lib.Universes.Cubical.TTGUModel (L : LvlStruct) where
